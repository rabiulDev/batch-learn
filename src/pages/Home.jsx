                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M1.66666 2.50037H18.3333V17.6387H1.66666V2.50037Z"
                        fill="white"
                      
                      ></path>
                    </mask>
                    <g mask="url(#mask0_2021_16691)">
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M2.91666 12.4829V14.187C2.91666 14.7754 3.145 15.3279 3.56083 15.7437C3.97666 16.1595 4.53 16.3887 5.1175 16.3887H14.8808C16.0942 16.3887 17.0825 15.402 17.0833 14.1887V12.482C16.0117 12.2045 15.2175 11.2287 15.2167 10.0712C15.2167 8.9137 16.0108 7.93787 17.0825 7.65953L17.0833 5.95537C17.0842 4.74037 16.0983 3.7512 14.8842 3.75037H5.12C3.90583 3.75037 2.9175 4.73787 2.91666 5.95203V7.7162C3.32166 7.81287 3.6975 8.01203 4.01 8.3037C4.48416 8.7462 4.7575 9.3462 4.78083 9.99453C4.78333 11.2162 3.98916 12.2029 2.91666 12.4829ZM14.8808 17.6387H5.11833C4.19583 17.6387 3.32916 17.2804 2.67666 16.6279C2.025 15.9754 1.66666 15.1087 1.66666 14.187V11.937C1.66666 11.592 1.94666 11.312 2.29166 11.312C2.97833 11.3112 3.53333 10.7545 3.5325 10.0712C3.52083 9.72287 3.3875 9.43287 3.1575 9.21787C2.92833 9.00287 2.63166 8.88537 2.31333 8.90287C2.14083 8.90453 1.97916 8.84537 1.8575 8.72787C1.73583 8.61037 1.66666 8.44703 1.66666 8.27787V5.95287C1.6675 4.0487 3.21666 2.50037 5.12 2.50037H14.88C16.7883 2.5012 18.335 4.05287 18.3333 5.9562V8.20537C18.3333 8.55037 18.0533 8.83037 17.7083 8.83037C17.0242 8.83037 16.4667 9.38703 16.4667 10.0704C16.4675 10.7554 17.0242 11.312 17.7083 11.312C18.0533 11.312 18.3333 11.592 18.3333 11.937V14.187C18.3325 16.0904 16.7833 17.6387 14.8808 17.6387Z"
                        fill="#95A3BD"
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M8.41992 9.48452L8.84408 9.89785C9.07408 10.1237 9.17825 10.4454 9.12325 10.7595L9.02325 11.3412L9.54742 11.0654C9.82992 10.9145 10.1691 10.9154 10.4541 11.067L10.9749 11.3404L10.8749 10.7579C10.8224 10.4387 10.9274 10.1195 11.1549 9.89785L11.5791 9.48452L10.9916 9.39952C10.6766 9.35368 10.4033 9.15535 10.2624 8.86785L9.99992 8.33702L9.73742 8.86868C9.59658 9.15535 9.32325 9.35368 9.00658 9.39952L8.41992 9.48452ZM11.3483 12.8229C11.1933 12.8229 11.0383 12.7854 10.8949 12.7095L9.99992 12.2404L9.10408 12.7104C8.77408 12.8829 8.38158 12.8554 8.08158 12.637C7.78075 12.4179 7.63325 12.0545 7.69575 11.6879L7.86658 10.6912L7.14242 9.98535C6.87658 9.72618 6.78158 9.34535 6.89575 8.99202C7.01075 8.63785 7.31075 8.38368 7.67825 8.33035L8.68158 8.18368L9.12908 7.27618C9.29325 6.94285 9.62658 6.73535 9.99992 6.73535C10.3716 6.73535 10.7058 6.94285 10.8699 7.27702L11.3183 8.18368L12.3199 8.33035C12.6883 8.38368 12.9891 8.63785 13.1033 8.99202C13.2174 9.34535 13.1233 9.72618 12.8566 9.98618L12.1316 10.692L12.3033 11.6879C12.3658 12.0554 12.2174 12.4195 11.9158 12.6379C11.7458 12.7604 11.5474 12.8229 11.3483 12.8229Z"
                      fill="#95A3BD"
                    ></path>
                  </svg>
                </span>
        ...
        <div className="flex items-center justify-between w-full">
          <div className="ml-9 home-icon-hover">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "active-home-style flex items-center font-semibold text-base font-nunito relative"
                  : "flex items-center font-semibold text-base font-nunito text-[#042040] relative home-hover"
              }
            >
              <span>
                <svg
